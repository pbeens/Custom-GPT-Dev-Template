...
> **CRITICAL**: Whenever a new prompt version is created (e.g., `prompts/Prompt_v0.02.md`), the `CHANGELOG.md` file MUST be updated immediately.

**Instructions**:
1.  Open `CHANGELOG.md`.
2.  Add a new section for the new version number (e.g., `## [v0.02] - YYYY-MM-DD`).
